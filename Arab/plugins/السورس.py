...
async def source(e):
    await edit_or_reply(e, "https://github.com/LOSFRMAOBK/TALEON",)
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ تـليثون طارق فون - Telethon-Arabe ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"🝳︙وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون طارق فون @BV_YQ :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , """🝳︙ جـاري تـحديث تليثـون طارق فون (7.7)
...
قناة الكلايش  : @BV_YQ
قناه شروحات الاوامر  : @BV_YQ
قناه المتغيرات او الفارات : @BV_YQ""")
...
async def variable(var):
    ...
    if exe == "get":
        ...
        if variable in heroku_var:
            await ics.edit("**⌔ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت  طارق فون تليثـون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
...
async def psu(event):
    ...
    cpufreq = psutil.cpu_freq()
    for i, percentage in enumerate(psutil.cpu_percent(percpu=True)):
        cpuu = "**حجم استخدامك لتليثون طارق فون :**\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inlineiqthon(iqthon):
        ...
        if query.startswith("تنصيب") and iqthon.query.user_id == bot.uid:
            buttons = [[Button.url("1- شرح التنصيب", "https://youtu.be/44t"), Button.url("2- استخراج ايبيات", "https://my.telegram.org/"),],[Button.url("3- ستخراج تيرمكس", "https://replit.com/@telethon-Arab/generatestringsession#start.sh"), Button.url("4- بوت فاذر", "http://t.me/BotFather"),],[Button.url("5- رابط التنصيب", "https://github.com/LOSFRMAOBK/TALEON"),],[Button.url("المطـور 👨🏼‍💻", "https://t.me/F_F_F_V"),]]
...
( .ايقاف اسم وقتي )
———————×———————
 🝳︙ يوجد شرح مفصل عن الامر هنا : https://t.me/BV_YQ
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/BV_YQ
مبرمج السورس : ( @F_F_F_V ) .
قناه السورس : ( @BV_YQ ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/BV_YQ
قناه السورس : ( @BV_YQ ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/BV_YQ
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/BV_YQ  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/BV_YQ  ⦒
""")
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**🝳︙ قـائمـه الاوامـر :**\n**🝳︙ قنـاه السـورس :** @BV_YQ\n**🝳︙ شـرح اوامـر السـورس : @BV_YQ**\n**🝳︙ شـرح فـارات السـورس : @BV_YQ** "
